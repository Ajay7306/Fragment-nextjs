...
import Subscriptionlay from '../../components/Subcriptionlay'


const checkout = () => {
  return <div className="flex flex-col justify-center items-center w-full bg-secondary-white dark:bg-secondary-dark gap-[40px]">
